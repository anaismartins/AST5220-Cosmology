...
private:
  ...
  // Constants from other modules and utils
  const double c = Constants.c;
  const double H0 = cosmo->get_H0();
  const double Omega_gamma0 = cosmo->get_OmegaGamma(0.0);
  const double Omega_nu0 = cosmo->get_OmegaNu(0.0);
  const double Omega_b0 = cosmo->get_OmegaB(0.0);
  const double Omega_CDM0 = cosmo->get_OmegaCDM(0.0);
